		...
		<div class="row">
			...
			<form action="" method="POST">
                ...
                <div class="custom-radio">
                    <input type="radio" id="html" name="xuly" value="0" checked="checked">
                    <label for="html">Chưa xử lý</label><br>
                    <input type="radio" id="css" name="xuly" value="1">
                    <label for="html">Duyệt</label><br>
                </div>
			...
			<div class="col-md-5">
				...
				<?php
				$sql_select = mysqli_query($con,"SELECT * FROM tbl_sanpham,tbl_khachhang,tbl_donhang 
